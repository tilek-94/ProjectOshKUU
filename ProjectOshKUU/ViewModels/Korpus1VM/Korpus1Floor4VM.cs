...
{
    public class Korpus1Floor4VM : BaseView
    {
        ...
        public Korpus1Floor4VM(IAudienceService service)
        {
            _service = service;
            GetAllProduct();
        ...
        private void CommandMethod(object NumberFlat)
        {
            ...
            {
                AddInformationWindow addInformationWindow = new(4, 1, Convert.ToInt16(NumberFlat), new AudienceService(new AppDbContext()));
        ...
        private async void GetAllProduct()
        {
            ...
            {
                AudienceNameList = await _service.GetByLangAsync(4, 1, StaticLanguageClass.Lang);
