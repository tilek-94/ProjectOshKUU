...
{
    public class Korpus1Floor3VM : BaseView
    {
        ...
        public Korpus1Floor3VM(IAudienceService service)
        {
            _service = service;
            GetAllProduct();
        ...
        private void CommandMethod(object NumberFlat)
        {
            ...
            {
                AddInformationWindow addInformationWindow = new(3, 1, Convert.ToInt16(NumberFlat), new AudienceService(new AppDbContext()));
        ...
        private async void GetAllProduct()
        {
            ...
            {
                AudienceNameList = await _service.GetByLangAsync(3, 1, StaticLanguageClass.Lang);
