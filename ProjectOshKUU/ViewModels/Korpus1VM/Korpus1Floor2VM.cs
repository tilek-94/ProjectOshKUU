...
{
    public class Korpus1Floor2VM : BaseView
    {
        ...
        public Korpus1Floor2VM(IAudienceService service)
        {
            _service = service;
            GetAllProduct();
        ...
        private void CommandMethod(object NumberFlat)
        {
            ...
            {
                AddInformationWindow addInformationWindow = new(2, 1, Convert.ToInt16(NumberFlat), new AudienceService(new AppDbContext()));
        ...
        private async void GetAllProduct()
        {
            ...
            {
                AudienceNameList = await _service.GetByLangAsync(2, 1, StaticLanguageClass.Lang);
